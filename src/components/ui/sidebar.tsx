...
function Sidebar({
  ...
  // Already inside !isMobile branch — force visible. Do not rely on md: or
  // JS/CSS breakpoint desync can leave the rail at display:none.
  return (
    <div
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-primary data-[active=true]:text-primary-foreground [&>svg]:data-[active=true]:text-primary-foreground data-[active=true]:font-medium',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
