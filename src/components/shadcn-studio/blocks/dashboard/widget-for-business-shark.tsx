      ...
      <CardContent className='space-y-6'>
        <div className='space-y-2'>
          ...
          {plans.map((plan, index) => (
            <Label
              key={index}
              className='has-[[aria-checked=true]]:border-primary dark:has-[[aria-checked=true]]:border-primary flex cursor-pointer items-center gap-3 rounded-md border px-4 py-2'
            >
